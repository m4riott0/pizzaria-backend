...
const CreateOrderControler_1 = require("./controllers/order/CreateOrderControler");
...
//--rotas de orders
router.post('/order', isAuthenticated_1.isAuthenticated, new CreateOrderControler_1.CreateOrderController().handle);
